...
//base url
String url ='https://www.mongoride.com/'; //add '/' at the end of the url as 'https://url.com/'
...
verifyUser(String number, int login, String password, String email, isOtp,
  ...
  // dio.options.followRedirects = true;  // Automatically follow redirects
  //
  // try {
  //   var body =   (number != '' && email != '')
  ...
  //     'https://www.mongoride.com/api/v1/driver/validate-mobile-for-login',
  //     data:body
  //   );
  //
